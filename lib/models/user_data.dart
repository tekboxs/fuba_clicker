class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      ...
      equipped: json['equipped'] != null 
          ...
          : null,
      rebirthData: json['rebirth_data'] != null 
          ? Map<String, dynamic>.from(json['rebirth_data']) 
          : null,
      achievements: json['achievements'] != null 
          ? List<String>.from(json['achievements']) 
          : null,
      achievementStats: json['achievements_stats'] != null 
          ? Map<String, double>.from(json['achievements_stats']) 
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'achievements_stats': achievementStats,
      'upgrades': upgrades,
    };
  }
}
