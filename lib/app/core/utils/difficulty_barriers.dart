...
class DifficultyBarrierManager {
  static final List<DifficultyBarrier> lootBoxBarriers = [
    ...
    const DifficultyBarrier(
      ...
      emoji: '🌟',
      asset: 'assets/images/divine_crate.png',
    ),
    const DifficultyBarrier(
      name: 'Caixa Transcendente',
    ...
    const DifficultyBarrier(
      ...
      emoji: '🌐',
      asset: 'assets/images/ominiversal_crate.png',
    ),
    const DifficultyBarrier(
      name: 'Caixas de Tek',
    ...
    const DifficultyBarrier(
      ...
      emoji: '👑',
      asset: 'assets/images/absolute_crate.png',
    ),
  ];
